...
#The script is adapted from https://github.com/jagabandhumishra/IEEE-VSSASR-Kaldi-mini-librispeech/blob/master/s5/run_tdnn.sh
...
stage=0  #0 for start, 17 for nn3 decoding
nj=5
...
test_sets="openslr_test cv_test iiith"        #"test_dev93 test_eval92"
#The triphone SAT model
gmm=tri_1800_24000_sat  # this is the source gmm-dir that we'll use for alignments; it
...
affix=1a   #affix for TDNN+LSTM directory e.g. "1a" or "1b", in case we change the configuriation.
common_egs_dir= 
reporting_email=
